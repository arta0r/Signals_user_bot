...
def _post(url: str, fields: dict, files: dict | None = None, retries: int = 3):
    """Module-level (not a TG method): `TG` never had a _post attribute, which is why
    every send silently failed with AttributeError in the wild."""
